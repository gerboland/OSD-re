...
#define NUM_GPIO_BANKS 5
static struct gpio_bank gpio_bank_24xx[NUM_GPIO_BANKS] = {
    { (void __iomem *)OMAP24XX_GPIO1_BASE, INT_24XX_GPIO_BANK1, IH_GPIO_BASE,       METHOD_GPIO_24XX },
    { (void __iomem *)OMAP24XX_GPIO2_BASE, INT_24XX_GPIO_BANK2, IH_GPIO_BASE + 32,  METHOD_GPIO_24XX },
    { (void __iomem *)OMAP24XX_GPIO3_BASE, INT_24XX_GPIO_BANK3, IH_GPIO_BASE + 64,  METHOD_GPIO_24XX },
    { (void __iomem *)OMAP24XX_GPIO4_BASE, INT_24XX_GPIO_BANK4, IH_GPIO_BASE + 96,  METHOD_GPIO_24XX },
    { (void __iomem *)OMAP24XX_GPIO5_BASE, INT_24XX_GPIO_BANK5, IH_GPIO_BASE + 128, METHOD_GPIO_24XX },
};
#else // CONFIG_MACH_ITOMAP2430
...
int omap_set_gpio_debounce(int gpio, int enable)
{
    struct gpio_bank *bank;
    void __iomem *reg;
    u32 gpio_bit = 1 << (gpio & 0x1f);
    u32 val;
...
int omap_set_gpio_debounce_time(int gpio, int enc_time)
{
    struct gpio_bank *bank;
    void __iomem *reg;
...
static int __init _omap_gpio_init(void)
{
    ...
    if (cpu_is_omap24xx()) {
        ...
        gpio_bank_count = NUM_GPIO_BANKS;
