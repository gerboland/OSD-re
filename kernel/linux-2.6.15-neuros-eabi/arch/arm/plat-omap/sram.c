...
#define VA_REQINFOPERM0     IO_ADDRESS(OMAP24XX_RTPM_BASE+0x048)
#define VA_READPERM0        IO_ADDRESS(OMAP24XX_RTPM_BASE+0x050)
#define VA_WRITEPERM0       IO_ADDRESS(OMAP24XX_RTPM_BASE+0x058)
#define VA_CONTROL_STAT     IO_ADDRESS(OMAP24XX_SCM_BASE+0x2F8)
...
static int is_sram_locked(void)
{
    ...
    if (type == GP_DEVICE) {
        ...
        if (cpu_is_omap243x()) {
            ...
            __raw_writel(0xC63E, VA_READPERM0);     /* all i-read */
            __raw_writel(0xC67E, VA_WRITEPERM0);    /* all i-write */
        }
...
// JBH ^^^^     omap_sram_size = 0x10000; /* 64K */
                omap_sram_size = 0xf000;  /* 62K */
        }
    } else {
