/*
 *  linux/arch/arm/mach-itdm320-20/time.c
 *
...
static unsigned long itdm320_gettimeoffset(void)
{
...
void __init time_init(void)
{
	...
	/* Setup the Prescalar */
	outw(CONFIG_TIMER0_TMPRSCL, IO_TIMER0_TMPRSCL);

	/* Setup the Divisor */
	outw(CONFIG_TIMER0_TMDIV, IO_TIMER0_TMDIV);
