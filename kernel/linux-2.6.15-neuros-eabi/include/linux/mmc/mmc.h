...
#define MMCSD_PUSH_PULL_MODE 		(0x0080)
#define MMCSD_OPEN_DRAIN_MODE		(0x0000)
...
struct mmc_data {
	...
	struct request		*req;/* request structure (use the sg list instead) */
#endif
	unsigned int		error;		/* data error */
	unsigned int		flags;

//#define MMC_DATA_WRITE	(1 << 8)
#define MMC_DATA_WRITE	((1 << 13) | (1 << 11))
//#define MMC_DATA_READ	(1 << 9)
#define MMC_DATA_READ	((1 << 13) | ~(1 << 11))
