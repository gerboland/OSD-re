...
#elif defined(CONFIG_ARCH_NTDEV_DM320) || defined(CONFIG_ARCH_NTR3_DM320) || defined(CONFIG_ARCH_ITDM320_20)
...
#if 0
static inline void SMC_DM320_DMA_insw(u_long ioaddr, int reg, void *data, int wordlen)
{
   volatile u16 *d_ptr;
   u_long dest_addr, net_addr;
   //int val;
...
#if 0
static inline void SMC_DM320_DMA_WAIT(void)
{
   while(1) {
      volatile u16 val;
      val = inw(IO_EMIF_DMACTL);
...
#if defined(SMC_DEBUG) && SMC_DEBUG > 0
