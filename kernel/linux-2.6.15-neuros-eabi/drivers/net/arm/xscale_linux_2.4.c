...
#if (LINUX_VERSION_CODE > KERNEL_VERSION(2,5,0))
#define PLATFORM_NAME		"XScale with Linux 2.6 r4"
...
#endif
#ifdef CONFIG_ARCH_ITDM320_20
//TODO: move it to menuconfig
//durai@isofttech.com
	dwLanBase = ioremap(0x60000000,0xFC);
	SMSC_TRACE("Using dwLanBase==0x%08lX",dwLanBase);
#endif
	...
	const DWORD dwLengthInBytes)
{
	...
	printk("---->%s called\n",__FUNCTION__);
	arm926_dma_flush_range(pStartAddress,(pStartAddress+dwLengthInBytes));
#else
