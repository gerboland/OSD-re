...
void ide_unregister(unsigned int index)
{
	...
	printk(KERN_INFO "[ide_unregister] index = %x\n", index);
...
// ISOFT_PORT
#ifdef CONFIG_BLK_DEV_ITDM320_20_IDE_HDD
    {
       extern void itdm320_20_ide_hdd_probe(void);
       itdm320_20_ide_hdd_probe();
    }
#endif /* CONFIG_BLK_DEV_ITDM320_20_IDE_HDD */
#ifdef CONFIG_BLK_DEV_ITDM320_20_IDE_CFC
    {
       extern void itdm320_20_ide_cfc_probe(void);
       itdm320_20_ide_cfc_probe();
    }
#endif /* CONFIG_BLK_DEV_ITDM320_20_IDE_CFC */
#ifdef CONFIG_BLK_DEV_ITOMAP2430_IDE_HDD
    {
       extern void itomap24xx_ide_hdd_probe(void);
       itomap24xx_ide_hdd_probe();
    }
#endif /* CONFIG_BLK_DEV_ITDM320_20_IDE_HDD */
	...
	h8300_ide_init();
#endif
#ifdef CONFIG_BLK_DEV_DAVINCI
	extern int palm_bk3710_init (void);
	palm_bk3710_init ();
#endif /*CONFIG_BLK_DEV_DAVINCI*/
}
