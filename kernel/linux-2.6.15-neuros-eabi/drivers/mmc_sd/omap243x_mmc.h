...
#define MMC_IRQ             INT_MMC_IRQ
#define OMAP_DMA_MMC_RX     OMAP_DMA_MMC1_RX
#define OMAP_DMA_MMC_TX     OMAP_DMA_MMC1_TX
#define MMC_SRC             0x4809C120
#define OMAP_MMC_OCR        0x00ffc000
#define MMC_CARD_PRESENT    0x1
/* HSMMC slot2 definitions
 * */
#elif CONFIG_OMAP2430_MMC2
#define MMC_IRQ             INT_MMC2_IRQ
#define OMAP_DMA_MMC_RX     OMAP_DMA_MMC2_RX
#define OMAP_DMA_MMC_TX     OMAP_DMA_MMC2_TX
#define MMC_SRC             0x480B4120
