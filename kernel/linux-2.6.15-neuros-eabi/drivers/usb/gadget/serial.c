...
#define EP0_MAXPACKET           64
#define CHIP         "net2272"
#define DRIVER_VERSION_NUM  0x2272
#define EP_IN_NUM  2							//change this!!
static const char EP_IN_NAME [] = "ep1in-bulk"; // Change this!!
#define EP_OUT_NUM  1 							//change this!!
static const char EP_OUT_NAME [] =  "ep2out-bulk"; //Change this!!
//#define FULLSPEED
//#define SELFPOWER           USB_CONFIG_ATT_SELFPOWER
static inline void hw_optimize(struct usb_gadget *gadget)
{
	/* Vishal: Cant think of any hardware optimizing at this point */
	return;
}
#endif
...
#define EP_IN_NUM  2
static const char EP_IN_NAME [] = "ep1in-bulk"; //"ep2-bulk-in";
#define EP_OUT_NUM  1
