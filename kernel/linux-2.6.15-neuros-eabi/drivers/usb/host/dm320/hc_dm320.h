...
#define sMemSize	0xc0	/* Total memory size */
#define cMemEnd		256

/*-------------------------------------------------------------------------
 * DM320H Register Control memory map
 * --Note:
 *      --DM320H only has one control register set from 0x00-0x04
 *      --DM320H has two control register set from 0x00-0x04 and 0x08-0x0c
 *------------------------------------------------------------------------*/
...
#define PID_IN		0x69
#define PID_OUT		0xe1
#define PID_DATA0	0xCE
#define PID_DATA1	0x4B

#define MAX_RETRY			0xffff
#define TIMEOUT				5	/* 2 mseconds */

#define DM320H_HOSTCTLREG		0
#define DM320H_BUFADDRREG		1
#define DM320H_BUFLNTHREG		2
#define DM320H_PKTSTATREG		3	/* read */
#define DM320H_PIDEPREG			3	/* write */
#define DM320H_XFERCNTREG		4	/* read */
#define DM320H_DEVADDRREG		4	/* write */
#define DM320H_CTLREG1			5
#define DM320H_INTENBLREG		6

#define DM320H_HOSTCTLREG_B		8
#define DM320H_BUFADDRREG_B		9
#define DM320H_BUFLNTHREG_B		0x0A
#define DM320H_PKTSTATREG_B		0x0B	/* read */
#define DM320H_PIDEPREG_B		0x0B	/* write */
#define DM320H_XFERCNTREG_B		0x0C	/* read */
#define DM320H_DEVADDRREG_B		0x0C	/* write */

#define DM320H_INTSTATREG		0x0D	/* write clears bitwise */
#define DM320H_HWREVREG			0x0E	/* read */
#define DM320H_SOFLOWREG		0x0E	/* write */
#define DM320H_SOFTMRREG		0x0F	/* read */
#define DM320H_CTLREG2			0x0F	/* write */
#define DM320H_DATA_START		0x10

/* Host control register bits (addr 0) */
#define DM320H_HCTLMASK_ARM		1
#define DM320H_HCTLMASK_ENBLEP		2
#define DM320H_HCTLMASK_WRITE		4
#define DM320H_HCTLMASK_ISOCH		0x10
#define DM320H_HCTLMASK_AFTERSOF	0x20
#define DM320H_HCTLMASK_SEQ		0x40
#define DM320H_HCTLMASK_PREAMBLE	0x80

/* Packet status register bits (addr 3) */
#define DM320H_STATMASK_ACK		1
#define DM320H_STATMASK_ERROR		2
#define DM320H_STATMASK_TMOUT		4
#define DM320H_STATMASK_SEQ		8
#define DM320H_STATMASK_SETUP		0x10
#define DM320H_STATMASK_OVF		0x20
#define DM320H_STATMASK_NAK		0x40
#define DM320H_STATMASK_STALL		0x80

/* Control register 1 bits (addr 5) */
#define DM320H_CTL1MASK_DSBLSOF		1
#define DM320H_CTL1MASK_NOTXEOF2	4
#define DM320H_CTL1MASK_DSTATE		0x18
#define DM320H_CTL1MASK_NSPD		0x20
#define DM320H_CTL1MASK_SUSPEND		0x40
#define DM320H_CTL1MASK_CLK12		0x80

#define DM320H_CTL1VAL_RESET		8

/* Interrupt enable (addr 6) and interrupt status register bits (addr 0xD) */
#define DM320H_INTMASK_XFERDONE		1
#define DM320H_INTMASK_SOFINTR		0x10
#define DM320H_INTMASK_INSRMV		0x20
#define DM320H_INTMASK_USBRESET		0x40
#define DM320H_INTMASK_DSTATE		0x80	/* only in status reg */

/* HW rev and SOF lo register bits (addr 0xE) */
#define DM320H_HWRMASK_HWREV		0xF0

/* SOF counter and control reg 2 (addr 0xF) */
#define DM320H_CTL2MASK_SOFHI		0x3F
#define DM320H_CTL2MASK_DSWAP		0x40
#define DM320H_CTL2MASK_HOSTMODE	0xae
