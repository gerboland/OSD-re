...
// appearently from kernel 2.6.12 the timeout parameter is expressed in MS, not Jiffies anymore
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,12)
    #define CONTROL_TIMEOUT CONTROL_TIMEOUT_MS
#else
    #define CONTROL_TIMEOUT CONTROL_TIMEOUT_JIFFIES
#endif
