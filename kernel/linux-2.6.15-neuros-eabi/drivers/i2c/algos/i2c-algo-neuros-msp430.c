 ...
 *
 * REVISION:
 * 4) Fix for I2C retry bug ----------------------------- 2007-04-12 nerochiaro
...
#define MOD_DESC "MSP430 I2C Driver (c) 2006"
...
static int i2c_write(u8 reg, u16 value)
{
...
static int __init irrtc_init(void)
{
    ...
    printk(KERN_INFO "FIXME: I should not be here!!!\n");
    {
